...
defalutPUWgtUrl="/afs/cern.ch/work/p/pmandrik/swork/2_btag_ttbar/7_jan_2018_SF/BTaggingCommission/lumis/processedLumis_puWgtXsec69000.root"

MC_PATH="/eos/cms/store/group/phys_btag/Commissioning/TTbar/Run2018/crab/22Jan2018_SF_Moriond19_MC/d93a314/"
DATA_PATH="/eos/cms/store/group/phys_btag/Commissioning/TTbar/Run2018/crab/22Jan2018_SF_Moriond19/d93a314/MuonEG/"
...
dataset['ttbar'] = {
    'xsec'              : 831.77,
    'ipath'             : [MC_PATH + 'TTTo2L2Nu_TuneCP5_PSweights_13TeV-powheg-pythia8'],
    'puWgtUrl'          : defalutPUWgtUrl,
}
...
dataset['dy2'] = {
    'xsec'              : 6025,
    'ipath'             : [MC_PATH + 'DYJetsToLL_M-50_TuneCP5_13TeV-amcatnloFXFX-pythia8'],
    'puWgtUrl'          : defalutPUWgtUrl,
}

dataset['st1'] = {
    'xsec'              : 35.85,
    'ipath'             : [MC_PATH + 'ST_tW_top_5f_inclusiveDecays_TuneCP5_PSweights_13TeV-powheg-pythia8'],
    'puWgtUrl'          : defalutPUWgtUrl,
}

dataset['st2'] = {
    'xsec'              : 35.85,
    'ipath'             : [MC_PATH + 'ST_tW_antitop_5f_inclusiveDecays_TuneCP5_PSweights_13TeV-powheg-pythia8'],
    'puWgtUrl'          : defalutPUWgtUrl,
}
