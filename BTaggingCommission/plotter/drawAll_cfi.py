...
mergedInputFile = [
    ...
    os.path.expandvars("/afs/cern.ch/work/p/pmandrik/swork/2_btag_ttbar/4_september_task/18Eep2018_2017/output_all.root"),
]
...
ttbarMC = {
    ...
    'drawOpt'   :"HIST",
    'isData'    :False,
    #'forceNorm' :"1.0/" + str(lumi), # Scale lumi to Run2018
...
altDATA = {
    ...
    'drawOpt'   :"E1",
    'isData'    :True,
    'forceNorm' : "forceNormS = cfg['data'][1]['hTotal'].GetSumOfWeights()/convHStackToHist(data['hTotal']).GetSumOfWeights()",
}

# Define config for plotters
ttbarConfig = {
    'data'      :[ttbarMC, defaultDATA, altDATA],
    'xTitle'    :"",
    'yTitle'    :"Events",
...
btagConfig = {
    'data'      :[btagMC, defaultDATA, altDATA],
    'xTitle'    :"",
    'yTitle'    :"Events",
    'stLegPos'  :[0.75,0.58,0.89,0.89],
    'ratioOpts' :["divsym"],
