...
{//{{{
    ...
    while(reader->Next()){//{{{
        ...
        //cout << passTrigSel(chan) << " " << passPresel (chan) << " " << passJetSel(chan).size() << endl;
    ...
    while(reader->Next()){//{{{
        ...
        cout << "T: " << evtWgt << " " << puWgt[puWgtBit] << " " << qcdWgt[qcdWgtBit] << " " << trigWgt[trigWgtBit] << " " << lepEffWgt[lepEffWgtBit] << endl;
...
{//{{{
    if (m_leaf.find(name.Data()) == m_leaf.end()){
        if( not ch->GetLeaf(name.Data()) ){
            cout << "!!! --- 2" << endl;
            cout << name.Data() << endl;
            cout << ch << endl;
            cout << ch->GetLeaf(name.Data()) << endl;
            cout << "GetLeaf failed" << endl;
            return;
        }
        // cout << ch->GetLeaf(name.Data())->GetTypeName() << endl;
        std::string leafType = ch->GetLeaf(name.Data())->GetTypeName();
        if ( leafType == "Int_t") {
            //cout << "Int_t " << name.Data() << endl;
            ...
            //cout << "Int_t " << name.Data() << " exit ..." << endl;
        }else if ( leafType == "Float_t"){
            //cout << "Float_t " << name.Data() << endl;
            ...
            //cout << "Float_t " << name.Data() << " exit ..." << endl;
        }else if ( leafType == "Double_t"){
            //cout << "Double_t " << name.Data() << endl;
            ...
            //cout << "Double_t " << name.Data() << " exit ..." << endl;
        }else{
...
{//{{{
    if (m_evtList.find(name.Data()) == m_evtList.end()){
        cout << "LOOK AT MEEE" << name.Data() << endl;
...
{//{{{
    ...
    for(unsigned int iCh=0; iCh<trigChannels.size(); iCh++){
        cout << iCh << " " << trigChannels[iCh] << " " << chan << endl;
...
{//{{{
    if (!isData && puWgtGr != 0){
        ...
        cout << nPUtrue << " " << puWgtGr  ->Eval(nPUtrue) << endl;
